...
object AmlsData {
  ...
  val registeredUserNoDataEntered = AmlsData(amlsRegistered = true, None, None, None)
  val nonRegisteredUserNoDataEntered = AmlsData(amlsRegistered = false, None, None, None)
