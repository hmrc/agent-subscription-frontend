...
@Singleton
class EmailVerificationConnector @Inject() (http: HttpClient, val metrics: Metrics)(implicit val appConfig: AppConfig, val ec: ExecutionContext)
  ...
  def checkEmail(credId: String)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Option[VerificationStatusResponse]] = {
