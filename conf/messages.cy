...
error.utr.invalid= Enter a valid Unique Taxpayer Reference (UTR)
error.utr.incorrectFormat =Rhaid i Gyfeirnod Unigryw y Trethdalwr (UTR) fod yn 10 rhif
error.sautr.blank=Nodwch y Cyfeirnod Unigryw y Trethdalwr (UTR) rydych yn ei ddefnyddio ar gyfer Hunanasesiad
error.sautr.invalid=Enter a valid Unique Taxpayer Reference (UTR)
error.sautr.incorrectFormat=Rhaid i’r Cyfeirnod Unigryw y Trethdalwr (UTR) rydych yn ei ddefnyddio ar gyfer Hunanasesiad fod yn 10 rhif
error.companyutr.blank=Nodwch Gyfeirnod Unigryw y Trethdalwr (UTR) eich cwmni
error.companyutr.invalid=Enter a valid Unique Taxpayer Reference (UTR)
error.companyutr.incorrectFormat=Rhaid i Gyfeirnod Unigryw y Trethdalwr (UTR) eich cwmni fod yn 10 rhif
error.partnershiputr.blank=Nodwch Gyfeirnod Unigryw y Trethdalwr (UTR) eich partneriaeth
error.partnershiputr.invalid=Enter a valid Unique Taxpayer Reference (UTR)
error.partnershiputr.incorrectFormat=Rhaid i Gyfeirnod Unigryw y Trethdalwr (UTR) eich partneriaeth fod yn 10 rhif
error.llputr.blank=Nodwch Gyfeirnod Unigryw y Trethdalwr (UTR) eich partneriaeth
error.llputr.invalid=Enter a valid Unique Taxpayer Reference (UTR)
error.llputr.incorrectFormat=Rhaid i Gyfeirnod Unigryw y Trethdalwr (UTR) eich partneriaeth atebolrwydd cyfyngedig (PAC) fod yn 10 rhif
error.client.sautr.blank=Nodwch Gyfeirnod Unigryw y Trethdalwr (UTR) y cleient ar gyfer Hunanasesiad
error.client.sautr.invalid=Enter a valid Unique Taxpayer Reference (UTR)
error.client.sautr.incorrectFormat=Rhaid i Gyfeirnod Unigryw y Trethdalwr (UTR) ar gyfer Hunanasesiad fod yn 10 rhif
...
task-list.amlsSubTask=Rhowch wybod i ni am eich cofrestriad ar gyfer goruchwyliaeth gwyngalchu arian
...
#Saved Progress
saved-progress.title=Mae eich cynnydd wedi’i gadw.
saved-progress.p1=Yr hyn y mae angen i chi ei wneud nesaf
saved-progress.p2=Mae’n rhaid i chi ddychwelyd a chwblhau’r ffurflen hon.
...
invasive.expandable.p1.open=Bydd eich cod asiant ar gyfer Hunanasesiad ar y llythyr a gawsoch gan CThEF pan wnaethoch gofrestru fel asiant ar gyfer Hunanasesiad. Cod sy’n cynnwys 6 o gymeriadau yw hwn – er enghraifft, SA1234.
